...
def Send_Goal():
    ...
    goal.target_pose.pose.position.y = -2.19
...
def topic_event_handler(msg):
    if msg.data != '5': # topic message
        return
    
    rospy.loginfo(f"[Topic Event] data:{msg.data}")

    rospy.loginfo(".....................")
    rospy.loginfo("Send_Goal : trash")
    rospy.loginfo(".....................")
...
rospy.init_node("my_node_trash") # node name
rospy.loginfo('my_node_trash start')
rospy.spin()
